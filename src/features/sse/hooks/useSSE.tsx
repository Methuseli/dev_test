...
export function useSSE(options: UseSSEOptions = {}): UseSSEReturn {
  ...
  const connect = useCallback(() => {
    ...
    try {
      ...
      eventSource.onerror = (error) => {
        ...
        if (shouldReconnectRef.current && connectionAttempts < maxReconnectAttempts) {
  ...
  }, [url, connectionAttempts, maxReconnectAttempts, reconnectInterval, onConnect, onError, addEvent]);
